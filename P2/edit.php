...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $stmt = $conexao->prepare("UPDATE eventos SET titulo = ?, descricao = ?, localizacao = ?, data_evento = ?, horario = ?, categoria = ?, imagem = ? WHERE id = ? AND usuario_id = ?");   
    $stmt ->bind_param("sssiissii", $titulo, $descricao, $localizacao, $data_evento, $horario, $categoria, $imagem, $id, $_SESSION['user_id']);
    $stmt ->execute();
